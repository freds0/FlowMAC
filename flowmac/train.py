...
from flowmac import utils

import torch

# Save the original reference of the load function
...
def _force_unsafe_load(f, map_location=None, pickle_module=None, **pickle_load_args):
    ...
    # If by chance it's not in args (older versions), define explicitly
    # Note: In Python < 3.10 this might vary, but in 3.12 it works like this
    pickle_load_args['weights_only'] = False
